...
const modulosData = {
    ...
    5: {
        ...
        opciones: [
            ...
            { id: '5_4', type: 'trampa', texto: "Omitir la firma de los testigos instrumentales en el acta de procedimiento bajo argumento de urgencia horaria.", fundacion: "Nulidad absoluta del instrumento público por ausencia de testigos obligatorios de ley." },
